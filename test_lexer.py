...
class TestLexer(unittest.TestCase):
    ...
    def test_format(self):
        string1 = ''
        string1 += 'Employees (id, name) = {\n'
        string1 += '    1, Jaan\n'
        string1 += '    2, Alex\n'
        string1 += '    3, Josh\n'
        string1 += '}\n'
        string1 += '\n'
        string1 += 'Payroll (id, salary, department) = {\n'
        string1 += '    1, 1000, Finance\n'
        string1 += '    2, 2000, Sales\n'
        string1 += '    3, 3000, HR\n'
        string1 += '}\n'
        string1 += '\n'
        string1 += 'Employees ⨝ Payroll\n'
        string1 += '\n'
        string1 += 'σ salary > 1000 (Employees ⨝ Payroll)\n'
        string1 += '\n'
        string1 += 'π id, name (σ salary > 1000 (Employees ⨝ Payroll))\n'
        string1 += '\n'
        string1 += '(π id, name (σ salary > 1000 (Employees ⨝ Payroll))) ⟗ Payroll\n'
        string1 += '\n'
        string1 += 'π name, department ((π id, name (σ salary > 1000 (Employees ⨝ Payroll))) ⟗ Payroll)\n'
        string1 += '\n'
        string1 += 'Cities (city, type) = {\n'
        string1 += '    Ottawa, Finance\n'
        string1 += '    Toronto, HR\n'
        string1 += '    Vancouver, Sales\n'
        string1 += '}\n'
        string1 += '\n'
        string1 += '(π name, department ((π id, name (σ salary > 1000 (Employees ⨝ Payroll))) ⟗ Payroll)) ⨝ department=type Cities\n'
        string1 += '\n'
        string2 = ''
        string2 += 'Employees ⨝ Payroll =\n'
        string2 += '(id, name, salary, department) = {\n'
        string2 += '    1, Jaan, 1000, Finance\n'
        string2 += '    2, Alex, 2000, Sales\n'
        string2 += '    3, Josh, 3000, HR\n'
        string2 += '}\n'
        string2 += '\n'
        string2 += 'σ salary > 1000 (Employees ⨝ Payroll) =\n'
        string2 += '(id, name, salary, department) = {\n'
        string2 += '    2, Alex, 2000, Sales\n'
        string2 += '    3, Josh, 3000, HR\n'
        string2 += '}\n'
        string2 += '\n'
        string2 += 'π id, name (σ salary > 1000 (Employees ⨝ Payroll)) =\n'
        string2 += '(id, name) = {\n'
        string2 += '    2, Alex\n'
        string2 += '    3, Josh\n'
        string2 += '}\n'
        string2 += '\n'
        string2 += '(π id, name (σ salary > 1000 (Employees ⨝ Payroll))) ⟗ Payroll =\n'
        string2 += '(id, name, salary, department) = {\n'
        string2 += '    2, Alex, 2000, Sales\n'
        string2 += '    3, Josh, 3000, HR\n'
        string2 += '    1, null, 1000, Finance\n'
        string2 += '}\n'
        string2 += '\n'
        string2 += 'π name, department ((π id, name (σ salary > 1000 (Employees ⨝ Payroll))) ⟗ Payroll) =\n'
        string2 += '(name, department) = {\n'
        string2 += '    Alex, Sales\n'
        string2 += '    Josh, HR\n'
        string2 += '    null, Finance\n'
        string2 += '}\n'
        string2 += '\n'
        string2 += '(π name, department ((π id, name (σ salary > 1000 (Employees ⨝ Payroll))) ⟗ Payroll)) ⨝ department=type Cities =\n'
        string2 += '(name, department, city) = {\n'
        string2 += '    Alex, Sales, Vancouver\n'
        string2 += '    Josh, HR, Toronto\n'
        string2 += '    null, Finance, Ottawa\n'
        string2 += '}\n'
        string2 += '\n'
        self.assertEqual(Lexer.format(string1), string2)
